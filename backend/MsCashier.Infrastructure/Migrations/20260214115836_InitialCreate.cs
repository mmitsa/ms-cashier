        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    YearlyPrice = table.Column<decimal>(type: "decimal(10,2)", precision: 10, scale: 2, nullable: true),
                    MaxUsers = table.Column<int>(type: "int", nullable: false),
                    MaxWarehouses = table.Column<int>(type: "int", nullable: false),
                    MaxPosStations = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ConversionRate = table.Column<decimal>(type: "decimal(18,6)", precision: 18, scale: 6, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    TenantId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ZatcaEnabled = table.Column<bool>(type: "bit", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HalfWholesalePrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    WholesalePrice = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    Price4 = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
                    MinStock = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    MaxStock = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReceivedQty = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TransactionType = table.Column<byte>(type: "tinyint", nullable: false),
                    Quantity = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    PreviousQty = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    NewQty = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ReferenceType = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    ReferenceId = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    Notes = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Notes = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: true),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ZatcaReported = table.Column<bool>(type: "bit", nullable: false),
                    ZatcaInvoiceHash = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Installments_Contacts_ContactId",
                        column: x => x.ContactId,
                        principalTable: "Contacts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.InsertData(
                table: "Plans",
                columns: new[] { "Id", "Features", "IsActive", "MaxPosStations", "MaxProducts", "MaxUsers", "MaxWarehouses", "MonthlyPrice", "Name", "YearlyPrice" },
                values: new object[,]
                {
                    { 1, null, true, 1, 500, 3, 1, 1400m, "أساسي", 14000m },
                    { 2, null, true, 3, 2000, 10, 3, 2800m, "متقدم", 28000m },
                    { 3, null, true, 10, null, 50, 10, 4200m, "احترافي", 42000m }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Attendances_TenantId_EmployeeId_AttendanceDate",
                table: "Attendances",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinanceAccounts_TenantId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinanceTransactions_CreatedAt",
                table: "FinanceTransactions",
                column: "CreatedAt");

            migrationBuilder.CreateIndex(
                name: "IX_FinanceTransactions_TenantId_AccountId",
                table: "FinanceTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Installments_ContactId",
                table: "Installments",
                column: "ContactId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryTransactions_TenantId_ProductId_WarehouseId",
                table: "InventoryTransactions",
                columns: new[] { "TenantId", "ProductId", "WarehouseId" });
