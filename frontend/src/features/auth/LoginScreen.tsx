...
export function LoginScreen({ onBack }: { onBack?: () => void }) {
  ...
  return (
    <div
      className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800"
      dir="rtl"
    >
      <div className="bg-white rounded-2xl shadow-2xl p-8 w-full max-w-md mx-4">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold text-gray-900">MS Cashier</h1>
          <p className="text-gray-500 mt-1">نظام نقاط البيع المتكامل</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                className="w-full px-4 py-3 rounded-xl border border-gray-200 focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none transition bg-gray-50 pl-12"
        ...
        {onBack && (
          <button
            onClick={onBack}
            className="mt-6 w-full flex items-center justify-center gap-2 text-sm text-gray-400 hover:text-gray-600 transition"
          >
