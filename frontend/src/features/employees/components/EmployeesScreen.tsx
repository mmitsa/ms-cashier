    ...
    <div className="space-y-6" dir="rtl">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">إدارة بيانات الموظفين</p>
        </div>
      ...
      <div className="card p-5">
        {isLoading ? (
          ...
          <div className="py-12 text-center">
            ...
            <p className="text-gray-500 font-medium">لا يوجد موظفون بعد</p>
          </div>
        ) : (
            ...
            <table className="w-full text-right">
              <thead>
                <tr className="border-b border-gray-100">
                  ...
                  <th className="py-3 px-4 text-sm font-semibold text-gray-500">المنصب</th>
                  <th className="py-3 px-4 text-sm font-semibold text-gray-500">القسم</th>
                  <th className="py-3 px-4 text-sm font-semibold text-gray-500">الراتب</th>
                  <th className="py-3 px-4 text-sm font-semibold text-gray-500">تاريخ التعيين</th>
              ...
              <tbody>
                {(employees ?? []).map((employee) => (
                  <tr key={employee.id} className="border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
                    ...
                    <td className="py-3 px-4">
                      <span className="text-sm font-bold text-gray-900">{formatCurrency(employee.basicSalary)}</span>
                    </td>
                    <td className="py-3 px-4 text-sm text-gray-600">{formatDate(employee.hireDate)}</td>
                    <td className="py-3 px-4">
