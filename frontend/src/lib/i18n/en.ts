...
export const en: Translations = {
  ...
  console: {
    ...
    logout: 'Sign Out',
    systemTagline: 'Complete Sales System',
  },
  ...
  modules: {
    ...
    rfidInventory: 'RFID & QR Inventory',
    floorPlan: 'Floor Zones',
    waiter: 'Waiter / Orders',
    kitchen: 'Kitchen Display',
    qrCodes: 'QR Customer Order',
  ...
  onlineStore: {
    title: 'Online Store',
    subtitle: 'Build and manage your online store in one place',
    ...
    customerDisplayDesc: 'Show order details on the customer display during checkout',
  },

  // ─── Loyalty ───
  loyaltyProgram: {
    title: 'Loyalty Points Program',
    subtitle: 'Reward your customers and keep them coming back',
  ...
  // ─── RFID / QR Inventory ───
  rfidQr: {
    title: 'RFID & QR Inventory',
    subtitle: 'Track inventory using RFID or QR codes',
  ...
  variants: {
    ...
    subtitle: 'Manage sizes, colors, and options',
